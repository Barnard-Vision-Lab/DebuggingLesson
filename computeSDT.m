function [d, c, c2, beta, hitR, FAR, corrected] = computeSDT(pres, resp)
%Compute signal detection measures: d' (d) and criterion (c), along with
%others. 
% by Alex White, 2011
% 
% Usage: [d, c, c2, beta, hitR, FAR, corrected = computeSDT(pres, resp)
% Input: 
